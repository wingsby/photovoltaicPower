...
from data.preprocess import getData, getValData
...
# Training
i = 0
for batch_x, batch_y in getData(batch_size):  # Prepare Data
...
forecast=sess.run([infer_op],feed_dict={X: val_x})
print(forecast)
